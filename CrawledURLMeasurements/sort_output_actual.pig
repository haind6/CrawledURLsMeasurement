...
myinput = load '/home/hdn11/input_sandy_full' as (srcurl:chararray, dsturl:chararray, date:chararray, text:chararray, type:chararray, datatype:chararray, size:chararray);

ordered_dsturl = ORDER myinput BY dsturl asc, date asc;
--ordered_date = ORDER ordered_dsturl BY date asc;
ordered_dsturl_by_date = filter ordered_dsturl by $2 matches '.*201306.*';
...
store ordered_dsturl_by_date_3 into '/home/hdn11/sandy_actual_201306';
