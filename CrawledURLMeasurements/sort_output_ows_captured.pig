myinput = load '/home/hdn11/input_ows_full/' as (srcurl:chararray, dsturl:chararray, date:chararray, text:chararray, type:chararray, datatype:chararray, size:chararray);
...
store ordered_srcurl_by_date_3 into '/home/hdn11/ows_captured_$DATE';
